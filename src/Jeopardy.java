...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		frame.pack();
		quizPanel.setLayout(new GridLayout(buttonCount, 1));
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			...
			askQuestion("What is the creature in the Chamber of Secrets?", "What is a basilisk?", 200);
...
askQuestion("What broomsticks do the Slytherin team have for Quidditch?", "What is a Nimbus 2001?", 400);
		
			// Clear the button text (set the button text to nothing)
		secondButton.setText(null);
		}
		if(buttonPressed == thirdButton){
			askQuestion("What was the dragon that Harry took the golden egg from?", "What is a Hungarian Horntail?", 600);
		}
		
		if(buttonPressed == fourthButton){
			askQuestion("What was the date of the Battle of Hogwarts (month and day, not year)", "When is May 2?", 800 );
			fifthButton.setText(null);
		}
		if(buttonPressed == fifthButton){
			askQuestion("What is Umbridge's full name", "Who is Dolores Jean Umbridge?", 1000 );
		}
	}
	...
	private void updateScore() {
		scoreBox.setText("You have $" + score);
	}
